...
public class GenericAlgorithm : MonoBehaviour
{
    ...
    {
        population = new CNN[initialPopulation];
    ...
    {
        controller.Reset(population[currentGenome]);
    }

    private void FillPopulationWithRandomValues(CNN[] newPopulation, int startingIndex)
    {
        while (startingIndex < initialPopulation)
        {
            newPopulation[startingIndex] = new CNN();
            newPopulation[startingIndex].Initialize(controller.LAYERS, controller.NEURONS);
            startingIndex++;
        }
    }

    public void Death(float fitness, CNN network)
    {
    ...
    private void Repopulate()
    {
        ...
        CNN[] newPopulation = PickBestPopulation();
    ...
    private void Mutate(CNN[] newPopulation)
    {
    ...
    private void Crossover(CNN[] newPopulation)
    {
    ...
    private CNN[] PickBestPopulation()
    {

        CNN[] newPopulation = new CNN[initialPopulation];
